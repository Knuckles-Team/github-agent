...
name: github-starter
description: >-
  Github API + MCP Server + A2A Server Use when working with Github via this package's MCP
...
license: MIT
tags: [github-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Github Starter Skill

Starter skill for the **Github** package. Use the `mcp-client` universal skill
