...
| `GITHUB_URL` | optional | API base (default `[configured-endpoint]`; set for GHES) |
| `GITHUB_TLS_PROFILE` | optional | Named AgentConfig TLS profile; peer and hostname verification are mandatory. |
| `GITHUB_TLS_PROFILE_REF` | optional | Reference-backed AgentConfig TLS profile selector. |
