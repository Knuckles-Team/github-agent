...
async def _repo_list(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'list'."""
...
async def _repo_get(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'get'."""
...
async def _repo_create(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'create'."""
...
async def _repo_delete(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'delete'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_update(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'update'."""
...
async def _repo_pages_get(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'pages_get'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_pages_create(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'pages_create'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_pages_update(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'pages_update'."""
    owner = kwargs.pop("owner", None)
    repo = kwargs.pop("repo", None)
    if not owner or not repo:
        return {
...
async def _repo_pages_delete(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'pages_delete'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_pages_builds(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'pages_builds'."""
    owner = kwargs.pop("owner", None)
    repo = kwargs.pop("repo", None)
    if not owner or not repo:
        return {
...
async def _repo_pages_request_build(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'pages_request_build'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_secrets_list(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'secrets_list'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_secrets_public_key(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'secrets_public_key'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    if not owner or not repo:
        return {
...
async def _repo_secrets_set(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'secrets_set'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
...
async def _repo_secrets_delete(client: Any, kwargs: dict, slim: bool) -> dict:
    """Handle github_repos action 'secrets_delete'."""
    owner = kwargs.get("owner")
    repo = kwargs.get("repo")
    secret_name = kwargs.get("secret_name")
    if not owner or not repo:
...
_REPO_ACTION_HANDLERS = {
    "list": _repo_list,
    "get": _repo_get,
    "create": _repo_create,
    "delete": _repo_delete,
    "update": _repo_update,
    "pages_get": _repo_pages_get,
    "pages_create": _repo_pages_create,
    "pages_update": _repo_pages_update,
    "pages_delete": _repo_pages_delete,
    "pages_builds": _repo_pages_builds,
    "pages_request_build": _repo_pages_request_build,
    "secrets_list": _repo_secrets_list,
    "secrets_public_key": _repo_secrets_public_key,
    "secrets_set": _repo_secrets_set,
    "secrets_delete": _repo_secrets_delete,
}


def _repo_destructive_guard(action: str, allow_destructive: bool) -> dict | None:
...
def register_repo_tools(mcp: FastMCP):
    ...
    async def github_repos(
        ...
        guard_error = _repo_destructive_guard(action, allow_destructive)
...
def register_graphql_tools(mcp: FastMCP):
    ...
    async def github_graphql(
        ...
        try:
            ...
            return {"error": f"Invalid variables JSON: {type(e).__name__}"}
